...
function Generator({ setPage }) {
    return (
        ...
        <div>
            <h2 className="text-4xl font-bold text-center mt-5  text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">Resume Ready Extension</h2>
            </div>
            <div className="flex flex-col">
...
<select id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
  <option selected>Write me a cover letter</option>
  <option value="CA">Write me a resume</option>
  <option value="FR">Am I fit for the job</option>
</select>
                    ...
                    {/* <h2 className="text-2xl font-bold">Resume Ready Extension</h2> */}
                    <button
                        onClick={() => { setPage(ROUTES.PROFILE); }}
                        className="border mr-[3px] p-4 border-solid border-gray-600 rounded-[100%] hover:text-white hover:bg-blue-500">
                        <VscGear />
                    </button>
                </div>
   ...
   <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
       ...
       <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
           ...
           <textarea id="editor" rows="8" class="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400 border-blue-700" placeholder="Always be job ready..." required></textarea>
       </div>
   </div>
   <button type="submit" class="flex ml-5 items-center px-5 py-2.5 text-sm font-medium text-center items-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800">
       <CgExport />
       Export as PDF
   </button>
</form>
                    ...
                    {/* <textarea id="yehektextareahai" rows={12} className="w-full" placeholder="Always be job ready..." /> */}
                {/* </div> */}
            </div>
        </div>
    )
